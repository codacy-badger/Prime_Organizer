	...
	*/
	...
	function get_tables_info($skip_authentication = false){
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'tb_vaga' => array(
					'Caption' => 'Vagas',
					'Description' => 'Registros de vagas',
					'tableIcon' => 'resources/table_icons/chair.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'tb_entrevista' => array(
					'Caption' => 'Atividades de R&S',
					'Description' => 'Registros di&#225;rios de contatos, entrevistas e encaminhamentos<br>',
					'tableIcon' => 'resources/table_icons/clock_red.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'tb_contratacao' => array(
					'Caption' => 'Colaboradores',
					'Description' => 'Registros de colaboradores.',
				...
				'tb_alocacao' => array(
					'Caption' => 'Aloca&#231;&#227;o',
					'Description' => 'Locais e projetos onde os recursos s&#227;o alocados.',
					'tableIcon' => 'resources/table_icons/travel.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'tb_recrutador' => array(
					'Caption' => 'Gestores',
					'Description' => 'Cadastro dos colaboradores que utilizam o sistema.',
				...
				'tb_empresa' => array(
					'Caption' => 'Contas',
					'Description' => 'Cadastro de empresas (clientes, fornecedores, parceiros, etc.)',
				...
				'tb_prova_tipo' => array(
					...
					'Description' => 'Cadastros de provas para aplica&#231;&#227;o.',
				...
				'tb_contato' => array(
					'Caption' => 'Contato',
					'Description' => 'Cadastro de clientes, prospects e leads.',
					'tableIcon' => 'resources/table_icons/group.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'tb_contato_tipo' => array(
					'Caption' => 'Tipos de relacionamento',
					'Description' => '',
					'tableIcon' => 'table.gif',
					'group' => $tg[4],
					'homepageShowCount' => 0
				...
				'tb_oportunidade' => array(
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/ruby.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
				),
				'tb_atendimento' => array(
					'Caption' => 'Atendimentos',
					'Description' => 'Cadastro de telefonemas, e-mails e reuni&#245;es.',
					'tableIcon' => 'resources/table_icons/comments.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'tb_oportunidade_tipo' => array(
					'Caption' => 'Tipos das oportunidades',
					'Description' => 'Classifique as oportunidades em tipos (pipelines).',
					'tableIcon' => 'table.gif',
					'group' => $tg[4],
					'homepageShowCount' => 0
				),
				'tb_oportunidade_estagio' => array(
					'Caption' => 'Est&#225;gios de oportunidades',
					'Description' => '',
					'tableIcon' => 'table.gif',
					'group' => $tg[4],
					'homepageShowCount' => 0
				...
				'tb_acompanhamento' => array(
					...
					'Description' => 'Registros de acompanhamento de contas.',
					'tableIcon' => 'resources/table_icons/hot.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'tb_contrato' => array(
					'Caption' => 'Contratos',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/document_mark_as_final.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'tb_campanha' => array(
					'Caption' => 'Campanha',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/advertising.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				),
				'tb_campanha_contato' => array(
					'Caption' => 'Contatos da campanha',
					'Description' => '',
					'tableIcon' => 'table.gif',
					'group' => $tg[2],
					'homepageShowCount' => 0
				...
				'tb_acompanhamento_colaborador' => array(
					'Caption' => 'Acompanhamento individual',
					'Description' => '',
					'tableIcon' => 'table.gif',
					'group' => $tg[1],
					'homepageShowCount' => 0
				...
				'tb_indicador' => array(
					'Caption' => 'Metas e Indicadores',
					'Description' => 'Cadastre metas e indicadores para gerar um hist&#243;rico de performance.',
					'tableIcon' => 'resources/table_icons/chart_up_color.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				),
				'tb_indicador_periodo' => array(
					'Caption' => 'Per&#237;odos dos indicadores',
					'Description' => '',
					'tableIcon' => 'table.gif',
					'group' => $tg[2],
					'homepageShowCount' => 0
				...
				'tb_fatura' => array(
					'Caption' => 'Faturamento',
					'Description' => 'Lan&#231;amento de faturas e notas fiscais.',
					'tableIcon' => 'resources/table_icons/blogs.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'tb_ajuste_colaborador' => array(
					'Caption' => 'Ajustes do Colaborador',
					'Description' => 'Registros de ajustes do pontos dos colaboradores',
	...
	if(!function_exists('getTableList')){
		function getTableList($skip_authentication = false){
			$arrTables = array(   
				'tb_vaga' => 'Vagas',
				'tb_entrevista' => 'Atividades de R&S',
				'tb_contratacao' => 'Colaboradores',
				'tb_alocacao' => 'Aloca&#231;&#227;o',
				'tb_recrutador' => 'Gestores',
				'tb_empresa' => 'Contas',
				'tb_prova_tipo' => 'Tipos de provas',
				'tb_contato' => 'Contato',
				'tb_contato_tipo' => 'Tipos de relacionamento',
				'tb_oportunidade' => 'Oportunidades',
				'tb_atendimento' => 'Atendimentos',
				'tb_oportunidade_tipo' => 'Tipos das oportunidades',
				'tb_oportunidade_estagio' => 'Est&#225;gios de oportunidades',
				'tb_acompanhamento' => 'Acompanhamento',
				'tb_contrato' => 'Contratos',
				'tb_campanha' => 'Campanha',
				'tb_campanha_contato' => 'Contatos da campanha',
				'tb_acompanhamento_colaborador' => 'Acompanhamento individual',
