	...
	*/
	...
	$schema = array(   
		...
		'tb_entrevista' => array(   
			...
			'vaga_id' => array('appgini' => 'INT unsigned not null '),
			'recrutador_id' => array('appgini' => 'INT unsigned not null '),
			'dta' => array('appgini' => 'DATE not null '),
			'int_qtd_contatos' => array('appgini' => 'SMALLINT not null '),
			'int_qtd_entrevistas' => array('appgini' => 'SMALLINT not null '),
			'int_qtd_encaminhamentos' => array('appgini' => 'SMALLINT not null ')
		),
		...
		'tb_alocacao' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'int_empresa' => array('appgini' => 'INT unsigned not null '),
			'str_nome' => array('appgini' => 'VARCHAR(150) ')
		),
		'tb_recrutador' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'str_nome' => array('appgini' => 'VARCHAR(150) not null '),
			'bol_status' => array('appgini' => 'TINYINT default \'1\' '),
			'bol_recrutador' => array('appgini' => 'TINYINT '),
			'bol_comercial' => array('appgini' => 'TINYINT ')
		),
		'tb_empresa' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'str_nome_fantasia' => array('appgini' => 'VARCHAR(150) not null '),
			'str_responsavel' => array('appgini' => 'INT unsigned not null '),
			'relacionamento_id' => array('appgini' => 'INT unsigned not null '),
			'cidade' => array('appgini' => 'VARCHAR(150) '),
			'uf' => array('appgini' => 'VARCHAR(2) not null ')
		),
		'tb_prova_tipo' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'str_nome' => array('appgini' => 'VARCHAR(150) not null '),
		...
		'tb_contato' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'empresa_id' => array('appgini' => 'INT unsigned not null '),
			'str_primeiro_nome' => array('appgini' => 'VARCHAR(150) not null '),
			'str_sobrenome' => array('appgini' => 'VARCHAR(150) '),
			'str_nivel' => array('appgini' => 'VARCHAR(150) not null '),
			'tipo_id' => array('appgini' => 'INT unsigned not null '),
			'str_email1' => array('appgini' => 'VARCHAR(150) not null '),
			'str_email2' => array('appgini' => 'VARCHAR(150) '),
			'str_telefone1' => array('appgini' => 'VARCHAR(150) '),
			'str_telefone2' => array('appgini' => 'VARCHAR(150) '),
			'str_telefone3' => array('appgini' => 'VARCHAR(150) '),
			'cidade' => array('appgini' => 'VARCHAR(150) '),
			'uf' => array('appgini' => 'VARCHAR(2) '),
			'dta_cadastro' => array('appgini' => 'DATE ')
		),
		...
		'tb_oportunidade' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'tipo_id' => array('appgini' => 'INT unsigned '),
			'estagio_id' => array('appgini' => 'INT unsigned not null '),
			'empresa_id' => array('appgini' => 'INT unsigned not null '),
			'contato_id' => array('appgini' => 'INT unsigned not null '),
			'str_demanda' => array('appgini' => 'VARCHAR(200) '),
			'dta_inicio' => array('appgini' => 'DATE not null '),
			'dta_prev_fechamento' => array('appgini' => 'DATE '),
			'int_probabilidade' => array('appgini' => 'SMALLINT not null '),
			'int_valor' => array('appgini' => 'DECIMAL(10,2) unsigned '),
			'int_parcelas' => array('appgini' => 'SMALLINT(2) not null default \'1\' '),
			'dta_proposta' => array('appgini' => 'DATE '),
			'str_proposta' => array('appgini' => 'VARCHAR(150) '),
			'str_anotacoes' => array('appgini' => 'TEXT '),
			'str_responsavel' => array('appgini' => 'VARCHAR(150) ')
		),
		'tb_atendimento' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'str_iniciativa' => array('appgini' => 'VARCHAR(150) not null '),
			'empresa_id' => array('appgini' => 'INT unsigned not null '),
			'contato_id' => array('appgini' => 'INT unsigned not null '),
			'str_meio' => array('appgini' => 'VARCHAR(150) '),
			'str_finalidade' => array('appgini' => 'VARCHAR(150) '),
			'dta' => array('appgini' => 'DATE not null '),
			'campanha_id' => array('appgini' => 'INT unsigned '),
			'usuario_id' => array('appgini' => 'INT unsigned not null '),
			'str_anotacoes' => array('appgini' => 'VARCHAR(255) ')
		),
		...
		'tb_acompanhamento' => array(   
			...
			'empresa_id' => array('appgini' => 'INT unsigned not null '),
			'contato_id' => array('appgini' => 'INT unsigned not null '),
			'contrato_id' => array('appgini' => 'INT unsigned not null '),
			'usuario_id' => array('appgini' => 'INT unsigned not null '),
			'dta' => array('appgini' => 'DATE not null '),
			'str_meio' => array('appgini' => 'VARCHAR(150) not null '),
			'str_statusgeral' => array('appgini' => 'VARCHAR(150) not null '),
			'str_clima_cliente' => array('appgini' => 'VARCHAR(150) not null '),
			'str_clima_equipe' => array('appgini' => 'VARCHAR(150) not null '),
			'str_observacoes' => array('appgini' => 'TEXT '),
			'str_acoes_corretivas' => array('appgini' => 'TEXT ')
		),
		'tb_contrato' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'empresa_id' => array('appgini' => 'INT unsigned not null '),
			'str_nome' => array('appgini' => 'VARCHAR(150) not null '),
			'dta_inicio' => array('appgini' => 'DATE not null '),
			'dta_termino' => array('appgini' => 'DATE '),
			'str_detalhes' => array('appgini' => 'TEXT '),
			'str_anexo' => array('appgini' => 'VARCHAR(150) '),
			'bol_status' => array('appgini' => 'TINYINT default \'1\' ')
		),
		'tb_campanha' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'str_nome' => array('appgini' => 'VARCHAR(150) not null '),
			'dta_inicio' => array('appgini' => 'DATE not null '),
			'st_descricao' => array('appgini' => 'TEXT ')
		),
		'tb_campanha_contato' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'campanha_id' => array('appgini' => 'INT unsigned not null '),
			'empresa_id' => array('appgini' => 'INT unsigned not null '),
			'contato_id' => array('appgini' => 'INT unsigned not null ')
		),
		'tb_acompanhamento_colaborador' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'dta_data' => array('appgini' => 'DATE '),
			'acompanhamento_id' => array('appgini' => 'INT unsigned '),
			'colaborador_id' => array('appgini' => 'INT unsigned '),
			'str_tipo' => array('appgini' => 'VARCHAR(150) not null '),
			'str_comentarios' => array('appgini' => 'TINYTEXT '),
			'str_responsavel' => array('appgini' => 'VARCHAR(150) ')
		),
		'tb_indicador' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'str_departamento' => array('appgini' => 'VARCHAR(150) not null '),
			'str_nome' => array('appgini' => 'VARCHAR(150) not null '),
			'str_descricao' => array('appgini' => 'VARCHAR(255) not null '),
			'str_unidade_medida' => array('appgini' => 'VARCHAR(10) not null ')
		),
		'tb_indicador_periodo' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'indicador_id' => array('appgini' => 'INT unsigned not null '),
			'str_unidade' => array('appgini' => 'VARCHAR(150) '),
			'str_vertical' => array('appgini' => 'VARCHAR(150) '),
			'str_responsavel' => array('appgini' => 'VARCHAR(150) '),
			'dta' => array('appgini' => 'DATE not null '),
			'flo_sazonalidade' => array('appgini' => 'DECIMAL(5,2) '),
			'int_meta' => array('appgini' => 'INT '),
			'int_meta_ajustada' => array('appgini' => 'INT '),
			'int_realizado' => array('appgini' => 'INT ')
		),
		'tb_fatura' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'empresa_id' => array('appgini' => 'INT unsigned not null '),
			'dta_emissao' => array('appgini' => 'DATE not null '),
			'dta_competencia' => array('appgini' => 'DATE not null '),
			'flo_valor' => array('appgini' => 'DECIMAL(10,2) not null '),
			'int_nf' => array('appgini' => 'SMALLINT '),
			'str_observacoes' => array('appgini' => 'VARCHAR(255) ')
		),
		'tb_ajuste_colaborador' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'str_responsavel' => array('appgini' => 'VARCHAR(150) '),
			'dta_data' => array('appgini' => 'DATE '),
			'colaborador_id' => array('appgini' => 'INT unsigned not null '),
			'str_ajuste' => array('appgini' => 'VARCHAR(150) not null '),
			'bol_evidencia' => array('appgini' => 'TINYINT(1) '),
		...
		'tb_requerimento' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'dta_requisicao' => array('appgini' => 'DATE '),
			...
			'str_reposicao' => array('appgini' => 'VARCHAR(40) not null default \'N&#195;O\' '),
			'str_recurso' => array('appgini' => 'VARCHAR(50) '),
			'str_horario' => array('appgini' => 'VARCHAR(20) not null '),
			'empresa_id' => array('appgini' => 'INT unsigned not null '),
			'str_alocacao' => array('appgini' => 'VARCHAR(40) not null default \'Recurso alocado na Prime Control\' '),
			'contato_id' => array('appgini' => 'INT unsigned not null '),
			'int_maquinas' => array('appgini' => 'INT '),
			'str_beneficios' => array('appgini' => 'VARCHAR(255) '),
			'int_salario' => array('appgini' => 'INT not null '),
			'bool_abertura' => array('appgini' => 'VARCHAR(40) not null '),
			'dta_indicacao' => array('appgini' => 'DATE '),
			'str_descricao' => array('appgini' => 'VARCHAR(255) ')
		)
	);
