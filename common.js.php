...
function tb_requerimento_validateData(){
	...
	/* Date field dta_indicacao can't be empty */
	if($j('#dta_indicacao-dd').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Prazo para indica&#231;&#227;o de candidatos", close: function(){ /* */ $j('#dta_indicacao-dd').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#dta_indicacao-mm').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Prazo para indica&#231;&#227;o de candidatos", close: function(){ /* */ $j('#dta_indicacao-mm').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#dta_indicacao').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Prazo para indica&#231;&#227;o de candidatos", close: function(){ /* */ $j('#dta_indicacao').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
