...
function tb_vaga_validateData(){
	...
	/* Field qtd_vagas can't be empty */
	if($j('#qtd_vagas').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Qtd. de vagas em aberto", close: function(){ /* */ $j('[name=qtd_vagas]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
...
function tb_requerimento_validateData(){
	...
	if($j('#int_n_vagas').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> N&#250;mero de Vagas", close: function(){ /* */ $j('[name=int_n_vagas]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field str_reposicao can't be empty */
	if($j('#str_reposicao').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Reposi&#231;&#227;o", close: function(){ /* */ $j('[name=str_reposicao]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field time_horario_entrada can't be empty */
	if($j('#time_horario_entrada').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Hor&#225;rio de Entrada", close: function(){ /* */ $j('[name=time_horario_entrada]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field time_horario_saida can't be empty */
	if($j('#time_horario_saida').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Hor&#225;rio de Sa&#237;da", close: function(){ /* */ $j('[name=time_horario_saida]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field empresa_id can't be empty */
	if($j('#empresa_id').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Empresa/Cliente Solicitante", close: function(){ /* */ $j('[name=empresa_id]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field contato_id can't be empty */
	if($j('#contato_id').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Nome do Contato", close: function(){ /* */ $j('[name=contato_id]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field str_gestor can't be empty */
	if($j('#str_gestor').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Gestor Imediato", close: function(){ /* */ $j('[name=str_gestor]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field str_telefone can't be empty */
	if($j('#str_telefone').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Tel. do Solicitante", close: function(){ /* */ $j('[name=str_telefone]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field str_email can't be empty */
	if($j('#str_email').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Email do Solicitante", close: function(){ /* */ $j('[name=str_email]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field float_salario can't be empty */
	if($j('#float_salario').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Sal&#225;rio/Budget", close: function(){ /* */ $j('[name=float_salario]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field int_maquinas can't be empty */
	if($j('#int_maquinas').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Quantas m&#225;quinas ser&#227;o necess&#225;rias?", close: function(){ /* */ $j('[name=int_maquinas]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	...
	/* Date field data_indicacao can't be empty */
	if($j('#data_indicacao-dd').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Prazo para indica&#231;&#227;o de candidatos", close: function(){ /* */ $j('#data_indicacao-dd').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#data_indicacao-mm').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Prazo para indica&#231;&#227;o de candidatos", close: function(){ /* */ $j('#data_indicacao-mm').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#data_indicacao').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Prazo para indica&#231;&#227;o de candidatos", close: function(){ /* */ $j('#data_indicacao').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
