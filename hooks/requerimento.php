<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'requerimento' table. 
	...
	*/
	...
	function requerimento_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function requerimento_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function requerimento_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function requerimento_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function requerimento_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['str_status'], $data['str_posicao'], $data['int_n_vagas'], $data['str_reposicao'], $data['str_recurso'], $data['time_horario_entrada'], $data['time_horario_saida'], $data['empresa_id'], $data['contato_id'], $data['str_gestor'], $data['str_telefone'], $data['str_email'], $data['float_salario'], $data['int_maquinas'], $data['str_beneficios'], $data['bool_abertura'], $data['data_indicacao'], $data['str_descricao']
	...
	*/
	...
	function requerimento_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function requerimento_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function requerimento_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function requerimento_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function requerimento_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function requerimento_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function requerimento_batch_actions(&$args){
