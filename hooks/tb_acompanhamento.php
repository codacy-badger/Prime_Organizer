<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_acompanhamento' table. 
	...
	*/
	...
	function tb_acompanhamento_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_acompanhamento_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_acompanhamento_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['empresa_id'], $data['contato_id'], $data['contrato_id'], $data['usuario_id'], $data['dta'], $data['str_meio'], $data['str_statusgeral'], $data['str_clima_cliente'], $data['str_clima_equipe'], $data['str_observacoes'], $data['str_acoes_corretivas']
	...
	*/
	...
	function tb_acompanhamento_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_acompanhamento_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['empresa_id'], $data['contato_id'], $data['contrato_id'], $data['usuario_id'], $data['dta'], $data['str_meio'], $data['str_statusgeral'], $data['str_clima_cliente'], $data['str_clima_equipe'], $data['str_observacoes'], $data['str_acoes_corretivas']
	...
	*/
	...
	function tb_acompanhamento_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_acompanhamento_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_acompanhamento_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_acompanhamento_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_acompanhamento_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_acompanhamento_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_acompanhamento_batch_actions(&$args){
