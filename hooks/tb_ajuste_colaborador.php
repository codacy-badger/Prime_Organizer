<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_ajuste_colaborador' table. 
	...
	*/
	...
	function tb_ajuste_colaborador_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_ajuste_colaborador_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_ajuste_colaborador_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['dta_data'], $data['colaborador_id'], $data['str_ajuste'], $data['bol_evidencia'], $data['int_quantidade'], $data['gestor_id'], $data['bol_notificacao']
	...
	*/
	...
	function tb_ajuste_colaborador_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['str_responsavel'], $data['dta_data'], $data['colaborador_id'], $data['str_ajuste'], $data['bol_evidencia'], $data['int_quantidade'], $data['gestor_id'], $data['bol_notificacao']
	...
	*/
	...
	function tb_ajuste_colaborador_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['dta_data'], $data['colaborador_id'], $data['str_ajuste'], $data['bol_evidencia'], $data['int_quantidade'], $data['gestor_id'], $data['bol_notificacao']
	...
	*/
	...
	function tb_ajuste_colaborador_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['str_responsavel'], $data['dta_data'], $data['colaborador_id'], $data['str_ajuste'], $data['bol_evidencia'], $data['int_quantidade'], $data['gestor_id'], $data['bol_notificacao']
	...
	*/
	...
	function tb_ajuste_colaborador_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_ajuste_colaborador_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_ajuste_colaborador_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_ajuste_colaborador_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_ajuste_colaborador_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_ajuste_colaborador_batch_actions(&$args){
