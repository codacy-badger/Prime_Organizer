<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_alocacao' table. 
	...
	*/
	...
	function tb_alocacao_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_alocacao_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_alocacao_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['int_empresa'], $data['str_nome']
	...
	*/
	...
	function tb_alocacao_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_alocacao_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['int_empresa'], $data['str_nome']
	...
	*/
	...
	function tb_alocacao_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_alocacao_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_alocacao_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_alocacao_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_alocacao_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_alocacao_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_alocacao_batch_actions(&$args){
