<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_atendimento' table. 
	...
	*/
	...
	function tb_atendimento_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_atendimento_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_atendimento_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['str_iniciativa'], $data['empresa_id'], $data['contato_id'], $data['str_meio'], $data['str_finalidade'], $data['dta'], $data['campanha_id'], $data['usuario_id'], $data['str_anotacoes']
	...
	*/
	...
	function tb_atendimento_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_atendimento_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['str_iniciativa'], $data['empresa_id'], $data['contato_id'], $data['str_meio'], $data['str_finalidade'], $data['dta'], $data['campanha_id'], $data['usuario_id'], $data['str_anotacoes']
	...
	*/
	...
	function tb_atendimento_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_atendimento_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_atendimento_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_atendimento_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_atendimento_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_atendimento_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_atendimento_batch_actions(&$args){
