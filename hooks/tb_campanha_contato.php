<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_campanha_contato' table. 
	...
	*/
	...
	function tb_campanha_contato_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_campanha_contato_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_campanha_contato_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['campanha_id'], $data['empresa_id'], $data['contato_id']
	...
	*/
	...
	function tb_campanha_contato_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_campanha_contato_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['campanha_id'], $data['empresa_id'], $data['contato_id']
	...
	*/
	...
	function tb_campanha_contato_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_campanha_contato_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_campanha_contato_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_campanha_contato_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_campanha_contato_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_campanha_contato_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_campanha_contato_batch_actions(&$args){
