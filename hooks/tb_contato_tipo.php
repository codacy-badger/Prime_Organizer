<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_contato_tipo' table. 
	...
	*/
	...
	function tb_contato_tipo_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_contato_tipo_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_contato_tipo_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function tb_contato_tipo_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_contato_tipo_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_contato_tipo_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_contato_tipo_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_contato_tipo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_contato_tipo_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_contato_tipo_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_contato_tipo_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_contato_tipo_batch_actions(&$args){
