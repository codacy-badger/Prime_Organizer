<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_contratacao' table. 
	...
	*/
	...
	function tb_contratacao_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_contratacao_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_contratacao_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['str_candidato_nome'], $data['dta_contratacao'], $data['dta_demissao'], $data['bol_gestor']
	...
	*/
	...
	function tb_contratacao_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_contratacao_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['str_candidato_nome'], $data['dta_contratacao'], $data['dta_demissao'], $data['bol_gestor']
	...
	*/
	...
	function tb_contratacao_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_contratacao_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_contratacao_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_contratacao_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_contratacao_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_contratacao_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_contratacao_batch_actions(&$args){
