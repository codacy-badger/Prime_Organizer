<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_contrato' table. 
	...
	*/
	...
	function tb_contrato_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_contrato_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_contrato_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['empresa_id'], $data['str_nome'], $data['dta_inicio'], $data['dta_termino'], $data['str_detalhes'], $data['str_anexo'], $data['bol_status']
	...
	*/
	...
	function tb_contrato_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_contrato_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['empresa_id'], $data['str_nome'], $data['dta_inicio'], $data['dta_termino'], $data['str_detalhes'], $data['str_anexo'], $data['bol_status']
	...
	*/
	...
	function tb_contrato_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_contrato_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_contrato_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_contrato_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_contrato_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_contrato_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_contrato_batch_actions(&$args){
