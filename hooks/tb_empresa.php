<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_empresa' table. 
	...
	*/
	...
	function tb_empresa_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_empresa_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_empresa_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['str_nome_fantasia'], $data['str_responsavel'], $data['relacionamento_id'], $data['cidade'], $data['uf']
	...
	*/
	...
	function tb_empresa_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_empresa_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['str_nome_fantasia'], $data['str_responsavel'], $data['relacionamento_id'], $data['cidade'], $data['uf']
	...
	*/
	...
	function tb_empresa_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_empresa_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_empresa_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_empresa_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_empresa_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_empresa_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_empresa_batch_actions(&$args){
