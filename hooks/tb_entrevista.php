<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_entrevista' table. 
	...
	*/
	...
	function tb_entrevista_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_entrevista_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_entrevista_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['empresa_id'], $data['vaga_id'], $data['recrutador_id'], $data['dta'], $data['int_qtd_contatos'], $data['int_qtd_entrevistas'], $data['int_qtd_encaminhamentos']
	...
	*/
	...
	function tb_entrevista_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_entrevista_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['empresa_id'], $data['vaga_id'], $data['recrutador_id'], $data['dta'], $data['int_qtd_contatos'], $data['int_qtd_entrevistas'], $data['int_qtd_encaminhamentos']
	...
	*/
	...
	function tb_entrevista_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_entrevista_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_entrevista_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_entrevista_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_entrevista_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_entrevista_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_entrevista_batch_actions(&$args){
