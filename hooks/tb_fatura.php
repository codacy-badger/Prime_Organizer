<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_fatura' table. 
	...
	*/
	...
	function tb_fatura_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_fatura_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_fatura_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['empresa_id'], $data['dta_emissao'], $data['dta_competencia'], $data['flo_valor'], $data['int_nf'], $data['str_observacoes']
	...
	*/
	...
	function tb_fatura_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_fatura_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['empresa_id'], $data['dta_emissao'], $data['dta_competencia'], $data['flo_valor'], $data['int_nf'], $data['str_observacoes']
	...
	*/
	...
	function tb_fatura_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_fatura_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_fatura_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_fatura_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_fatura_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_fatura_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_fatura_batch_actions(&$args){
