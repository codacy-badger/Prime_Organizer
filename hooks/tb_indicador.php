<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_indicador' table. 
	...
	*/
	...
	function tb_indicador_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_indicador_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['str_departamento'], $data['str_nome'], $data['str_descricao'], $data['str_unidade_medida']
	...
	*/
	...
	function tb_indicador_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['str_departamento'], $data['str_nome'], $data['str_descricao'], $data['str_unidade_medida']
	...
	*/
	...
	function tb_indicador_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_indicador_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_batch_actions(&$args){
