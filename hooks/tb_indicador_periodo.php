<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_indicador_periodo' table. 
	...
	*/
	...
	function tb_indicador_periodo_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_periodo_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_indicador_periodo_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['indicador_id'], $data['str_unidade'], $data['str_vertical'], $data['str_responsavel'], $data['dta'], $data['flo_sazonalidade'], $data['int_meta'], $data['int_meta_ajustada'], $data['int_realizado']
	...
	*/
	...
	function tb_indicador_periodo_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_periodo_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['indicador_id'], $data['str_unidade'], $data['str_vertical'], $data['str_responsavel'], $data['dta'], $data['flo_sazonalidade'], $data['int_meta'], $data['int_meta_ajustada'], $data['int_realizado']
	...
	*/
	...
	function tb_indicador_periodo_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_periodo_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_periodo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_periodo_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_periodo_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_indicador_periodo_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_indicador_periodo_batch_actions(&$args){
