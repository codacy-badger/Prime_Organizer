<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_oportunidade' table. 
	...
	*/
	...
	function tb_oportunidade_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_oportunidade_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['tipo_id'], $data['estagio_id'], $data['empresa_id'], $data['contato_id'], $data['str_demanda'], $data['dta_inicio'], $data['dta_prev_fechamento'], $data['int_probabilidade'], $data['int_valor'], $data['int_parcelas'], $data['dta_proposta'], $data['str_proposta'], $data['str_anotacoes']
	...
	*/
	...
	function tb_oportunidade_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['tipo_id'], $data['estagio_id'], $data['empresa_id'], $data['contato_id'], $data['str_demanda'], $data['dta_inicio'], $data['dta_prev_fechamento'], $data['int_probabilidade'], $data['int_valor'], $data['int_parcelas'], $data['dta_proposta'], $data['str_proposta'], $data['str_anotacoes'], $data['str_responsavel']
	...
	*/
	...
	function tb_oportunidade_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_id'], $data['estagio_id'], $data['empresa_id'], $data['contato_id'], $data['str_demanda'], $data['dta_inicio'], $data['dta_prev_fechamento'], $data['int_probabilidade'], $data['int_valor'], $data['int_parcelas'], $data['dta_proposta'], $data['str_proposta'], $data['str_anotacoes']
	...
	*/
	...
	function tb_oportunidade_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_id'], $data['estagio_id'], $data['empresa_id'], $data['contato_id'], $data['str_demanda'], $data['dta_inicio'], $data['dta_prev_fechamento'], $data['int_probabilidade'], $data['int_valor'], $data['int_parcelas'], $data['dta_proposta'], $data['str_proposta'], $data['str_anotacoes'], $data['str_responsavel']
	...
	*/
	...
	function tb_oportunidade_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_oportunidade_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_batch_actions(&$args){
