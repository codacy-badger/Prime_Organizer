<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_oportunidade_estagio' table. 
	...
	*/
	...
	function tb_oportunidade_estagio_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_estagio_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_oportunidade_estagio_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function tb_oportunidade_estagio_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_estagio_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_id'], $data['str_nome']
	...
	*/
	...
	function tb_oportunidade_estagio_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_estagio_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_estagio_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_estagio_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_estagio_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_oportunidade_estagio_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_estagio_batch_actions(&$args){
