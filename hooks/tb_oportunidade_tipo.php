<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_oportunidade_tipo' table. 
	...
	*/
	...
	function tb_oportunidade_tipo_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_tipo_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_oportunidade_tipo_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function tb_oportunidade_tipo_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_tipo_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_tipo_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_tipo_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_tipo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_tipo_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_tipo_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_oportunidade_tipo_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_oportunidade_tipo_batch_actions(&$args){
