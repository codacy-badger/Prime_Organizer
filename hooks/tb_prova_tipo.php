<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tb_prova_tipo' table. 
	...
	*/
	...
	function tb_prova_tipo_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tb_prova_tipo_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tb_prova_tipo_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['str_nome'], $data['str_descricao']
	...
	*/
	...
	function tb_prova_tipo_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_prova_tipo_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['str_nome'], $data['str_descricao']
	...
	*/
	...
	function tb_prova_tipo_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tb_prova_tipo_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tb_prova_tipo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tb_prova_tipo_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tb_prova_tipo_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tb_prova_tipo_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tb_prova_tipo_batch_actions(&$args){
