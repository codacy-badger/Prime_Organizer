		...
		$pcConfig = array(
			'tb_vaga' => array(   
				'empresa_id' => array(   
					...
					'forced-where' => '',
					'display-fields' => array(1 => 'Requerimento', 2 => 'Vaga', 3 => 'Data de abertura', 4 => 'Data fechamento', 5 => 'Empresa', 6 => 'Aloca&#231;&#227;o', 7 => 'Recrutador', 8 => 'Posi&#231;&#227;o', 9 => 'Prioridade', 10 => 'Status', 11 => 'Data de previs&#227;o de fechamento', 12 => 'Observa&#231;&#245;es'),
					'display-field-names' => array(1 => 'requerimento_id', 2 => 'int_vaga_numero', 3 => 'dta_abertura', 4 => 'dta_fechamento', 5 => 'empresa_id', 6 => 'str_alocacao', 7 => 'recrutador_id', 8 => 'str_posicao', 9 => 'str_prioridade', 10 => 'str_status', 11 => 'dta_previsao_fechamento', 12 => 'str_obs'),
					'sortable-fields' => array(0 => '`tb_vaga`.`id`', 1 => '`tb_requerimento1`.`id`', 2 => '`tb_vaga`.`int_vaga_numero`', 3 => 'date_format(`tb_requerimento2`.`dta_abertura`,\'%d/%m/%Y\')', 4 => '`tb_vaga`.`dta_fechamento`', 5 => '`tb_empresa1`.`str_nome_fantasia`', 6 => '`tb_alocacao1`.`str_nome`', 7 => '`tb_recrutador1`.`str_nome`', 8 => 9, 9 => 10, 10 => 11, 11 => '`tb_vaga`.`dta_previsao_fechamento`', 12 => 13, 13 => '`tb_vaga`.`dta_inicio`', 14 => 15),
					'records-per-page' => 10,
					'default-sort-by' => 3,
