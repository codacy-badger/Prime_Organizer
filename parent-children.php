		...
		$pcConfig = array(
			'tb_vaga' => array(   
				'requerimento_id' => array(   
					...
					'forced-where' => '',
					'display-fields' => array(1 => 'Requerimento', 2 => 'Vaga', 3 => 'Empresa', 4 => 'Aloca&#231;&#227;o', 5 => 'Recrutador', 6 => 'Posi&#231;&#227;o', 7 => 'Data de abertura', 8 => 'Prioridade', 9 => 'Status', 10 => 'Data fechamento', 11 => 'Data de previs&#227;o de fechamento', 12 => 'Observa&#231;&#245;es'),
					'display-field-names' => array(1 => 'requerimento_id', 2 => 'int_vaga_numero', 3 => 'empresa_id', 4 => 'str_alocacao', 5 => 'recrutador_id', 6 => 'str_posicao', 7 => 'dta_abertura', 8 => 'str_prioridade', 9 => 'str_status', 10 => 'dta_fechamento', 11 => 'dta_previsao_fechamento', 12 => 'str_obs'),
					'sortable-fields' => array(0 => '`tb_vaga`.`id`', 1 => '`tb_requerimento1`.`id`', 2 => '`tb_vaga`.`int_vaga_numero`', 3 => '`tb_empresa1`.`str_nome_fantasia`', 4 => '`tb_alocacao1`.`str_nome`', 5 => 6, 6 => 7, 7 => '`tb_vaga`.`dta_abertura`', 8 => 9, 9 => 10, 10 => '`tb_vaga`.`dta_fechamento`', 11 => '`tb_vaga`.`dta_previsao_fechamento`', 12 => 13, 13 => '`tb_vaga`.`dta_inicio`', 14 => 15),
					'records-per-page' => 10,
					'default-sort-by' => 7,
