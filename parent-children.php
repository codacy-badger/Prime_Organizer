		...
		$pcConfig = array(
			'tb_vaga' => array(   
				'empresa_id' => array(   
					...
					'sortable-fields' => array(0 => '`tb_vaga`.`id`', 1 => '`tb_requerimento1`.`id`', 2 => '`tb_vaga`.`int_vaga_numero`', 3 => '`tb_vaga`.`dta_abertura`', 4 => '`tb_vaga`.`dta_previsao_fechamento`', 5 => '`tb_vaga`.`dta_fechamento`', 6 => 7, 7 => '`tb_empresa1`.`str_nome_fantasia`', 8 => '`tb_alocacao1`.`str_nome`', 9 => 10, 10 => 11, 11 => 12, 12 => 13, 13 => 14, 14 => '`tb_vaga`.`dta_inicio`', 15 => 16),
					'records-per-page' => 10,
					'default-sort-by' => 3,
