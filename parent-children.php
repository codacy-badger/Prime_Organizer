		...
		$pcConfig = array(
			'tb_vaga' => array(   
				'empresa_id' => array(   
					...
					'forced-where' => '',
					'display-fields' => array(1 => 'Empresa', 2 => 'Aloca&#231;&#227;o', 3 => 'Recrutador', 4 => 'Posi&#231;&#227;o', 5 => 'Data de abertura', 6 => 'Qtd. de vagas em aberto', 7 => 'Prioridade', 8 => 'Status', 9 => 'Data fechamento', 10 => 'Data de previs&#227;o de fechamento', 11 => 'Observa&#231;&#245;es'),
					'display-field-names' => array(1 => 'empresa_id', 2 => 'str_alocacao', 3 => 'recrutador_id', 4 => 'str_posicao', 5 => 'dta_abertura', 6 => 'qtd_vagas', 7 => 'str_prioridade', 8 => 'str_status', 9 => 'dta_fechamento', 10 => 'dta_previsao_fechamento', 11 => 'str_obs'),
					'sortable-fields' => array(0 => '`tb_vaga`.`id`', 1 => '`tb_empresa1`.`str_nome_fantasia`', 2 => '`tb_alocacao1`.`str_nome`', 3 => '`tb_recrutador1`.`str_nome`', 4 => 5, 5 => '`tb_vaga`.`dta_abertura`', 6 => '`tb_vaga`.`qtd_vagas`', 7 => 8, 8 => 9, 9 => '`tb_vaga`.`dta_fechamento`', 10 => '`tb_vaga`.`dta_previsao_fechamento`', 11 => 12, 12 => '`tb_vaga`.`dta_inicio`', 13 => 14),
					'records-per-page' => 10,
					'default-sort-by' => 5,
					...
					'query' => "SELECT `tb_vaga`.`id` as 'id', IF(    CHAR_LENGTH(`tb_empresa1`.`str_nome_fantasia`), CONCAT_WS('',   `tb_empresa1`.`str_nome_fantasia`), '') as 'empresa_id', IF(    CHAR_LENGTH(`tb_alocacao1`.`str_nome`), CONCAT_WS('',   `tb_alocacao1`.`str_nome`), '') as 'str_alocacao', IF(    CHAR_LENGTH(`tb_recrutador1`.`str_nome`), CONCAT_WS('',   `tb_recrutador1`.`str_nome`), '') as 'recrutador_id', `tb_vaga`.`str_posicao` as 'str_posicao', if(`tb_vaga`.`dta_abertura`,date_format(`tb_vaga`.`dta_abertura`,'%d/%m/%Y'),'') as 'dta_abertura', `tb_vaga`.`qtd_vagas` as 'qtd_vagas', `tb_vaga`.`str_prioridade` as 'str_prioridade', `tb_vaga`.`str_status` as 'str_status', if(`tb_vaga`.`dta_fechamento`,date_format(`tb_vaga`.`dta_fechamento`,'%d/%m/%Y'),'') as 'dta_fechamento', if(`tb_vaga`.`dta_previsao_fechamento`,date_format(`tb_vaga`.`dta_previsao_fechamento`,'%d/%m/%Y'),'') as 'dta_previsao_fechamento', `tb_vaga`.`str_obs` as 'str_obs', if(`tb_vaga`.`dta_inicio`,date_format(`tb_vaga`.`dta_inicio`,'%d/%m/%Y'),'') as 'dta_inicio', `tb_vaga`.`str_contratado_nome` as 'str_contratado_nome' FROM `tb_vaga` LEFT JOIN `tb_empresa` as tb_empresa1 ON `tb_empresa1`.`id`=`tb_vaga`.`empresa_id` LEFT JOIN `tb_alocacao` as tb_alocacao1 ON `tb_alocacao1`.`id`=`tb_vaga`.`str_alocacao` LEFT JOIN `tb_recrutador` as tb_recrutador1 ON `tb_recrutador1`.`id`=`tb_vaga`.`recrutador_id` "
				),
				'str_alocacao' => array(   
