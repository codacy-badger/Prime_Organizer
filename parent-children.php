		...
		$pcConfig = array(
			'tb_vaga' => array(   
				'requerimento_id' => array(   
					...
					'forced-where' => '',
					'display-fields' => array(1 => 'REQ', 2 => 'Vaga', 3 => 'Data de abertura', 5 => 'Data fechamento', 6 => 'Posi&#231;&#227;o', 7 => 'Empresa', 9 => 'Recrutador', 10 => 'Prioridade', 11 => 'Status', 12 => 'Observa&#231;&#245;es'),
					'display-field-names' => array(1 => 'requerimento_id', 2 => 'int_vaga_numero', 3 => 'dta_abertura', 5 => 'dta_fechamento', 6 => 'str_posicao', 7 => 'empresa_id', 9 => 'recrutador_id', 10 => 'str_prioridade', 11 => 'str_status', 12 => 'str_obs'),
					'sortable-fields' => array(0 => '`tb_vaga`.`id`', 1 => '`tb_requerimento1`.`id`', 2 => '`tb_vaga`.`int_vaga_numero`', 3 => '`tb_vaga`.`dta_abertura`', 4 => '`tb_vaga`.`dta_previsao_fechamento`', 5 => '`tb_vaga`.`dta_fechamento`', 6 => 7, 7 => '`tb_empresa1`.`str_nome_fantasia`', 8 => '`tb_alocacao1`.`str_nome`', 9 => 10, 10 => 11, 11 => 12, 12 => 13, 13 => '`tb_vaga`.`dta_inicio`', 14 => 15),
					'records-per-page' => 10,
					'default-sort-by' => 3,
