...
<?php $current_table = 'tb_oportunidade'; ?>
<?php
			...
			<table class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][12]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][12]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><?php if($record[12]){ ?><a href="link.php?t=<?php echo $parameters['ChildTable']; ?>&f=str_proposta&i=<?php echo urlencode($record[$config['child-primary-key-index']]); ?>" target="_blank" class="btn btn-default" title="<?php echo html_attr($record[12]); ?>"><i class="glyphicon glyphicon-file text-info"></i></a><?php } ?></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
